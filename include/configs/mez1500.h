...
#define CONFIG_MEZ1500		1	/* on a MIN2440 Board  */
 ...
 */
/* #define CONFIG_MEZ1500_NOR_ENV		1 */

// 20110211 SV: Suppress NOR flash not found msg
#define CFG_FLASH_QUIET_TEST	1

#define CONFIG_MEZ1500_OVERCLOCK 1	/* allow use of frequencies over 405Mhz */
 ...
 */
#define CONFIG_SERIAL3    1	/* we use SERIAL 3 on MEZ1500  */ 
...
#define CONFIG_BOOTARGS    	"console=ttySAC2,115200 root=/dev/mmcblk0p2 rootfstype=ext3 mez1500=0tb rootdelay=3 init=/linuxrc"
...
//#define CONFIG_BOOTCOMMAND	"nboot.e kernel \; bootm"


//#define CONFIG_BOOTCOMMAND	"mmcinit \; ext2load mmc 0:2 0x31000000 uImage \; bootm 0x31000000"

#define CONFIG_BOOTCOMMAND	"mmcinit \; ext2load mmc 0:2 0x31000000 boot/uImage \; bootm 0x31000000"
...
#define	CFG_PROMPT		"MEZ1500 # "	/* Monitor Command Prompt	*/
